    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav main_nav">
          ...
          <li><a href="pages/technology.html">sản phẩm</a></li>
        ...
        <ul class="nav navbar-nav drop-bag" style="float:right; width:120px;">
        	<li class="dropdown" style="float:right;"> <a href="#" class="" data-toggle="dropdown" role="button" aria-expanded="false">Giỏ Hàng(2)</a>
            <ul class="dropdown-menu" role="menu">
              <li>
              	<div>
              		<img src="images/featured_img1.jpg" alt="" width="100px">
              		<h3 style="color:Red;">tên</h3>
