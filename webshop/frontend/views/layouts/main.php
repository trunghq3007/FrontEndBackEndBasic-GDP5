        ...
        <header class="clearfix">
            <div class="headertop container">
                <div id="welcomeLine" class="row">
                    <div class="col-md-6">Welcome!<strong> User</strong></div>
                    <div class="col-md-6">
                    ...
                    <div class="container">
                        <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="#"><img src="themes/images/logo.png" alt="Bootsshop"/></a>
                            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <li><a href="login.html">PERSONAL INFORMATION</a> </li>
                <li><a href="login.html">ADDRESSES</a> </li>
                <li><a href="login.html">DISCOUNT</a>  </li>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <li><a href="#">SUPPLIERS</a> </li></ul>
             </div>
            <div id="socialMedia" class="col-md-3 pull-righ col-sm-3 col-xs-12t">
                <h5>SOCIAL MEDIA </h5>
