...
<body>
	<div class="wapper">
		<div class="header">
			<div class="container cleafix">
				<div class="float-left logo-left">
					<img src="./img/logo-lisaho.png" alt=""> <img
						src="./img/logo-southbank.png" alt="">
				</div>
						...
						<div class="container_login_ab">
							<form action="ContactController" method="POST">
								<input type="text" name="hoten" id="hoten"
									...
									name="dienthoai" id="dienthoai" placeholder="Điện thoại"
									onchange="validatePhone(this)"> <br> <select
									name="noio" id="noio">
									<option value="Nơi Ở">Nơi Ở</option>
									<option value="Hà Nội">Hà Nội</option>
									<option value="Đà Nẵng">Đà Nẵng</option>
									<option value="TPHCM">TP.HCM</option>
								</select><br> <select name="tonghiep" id="totnghiep">
								...
								</select><br> <select name="nganh" id="nganh">
								...
								</select><br> <input type="email" name="email" id="email"
		...
		<div class="container container-top_20 cleafix">
			<h3 class="mauxanh">Lorem ipsum dolor sit amet consectetur
				adipisicing elit.</h3>
			<div class="container">
			...
			<div class="container">
				<div class="float-left column">
					...
					<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
						Expedita modi eligendi aliquam?</p>
				</div>
			</div>
			<div class="container">
				<div class="float-left column">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
						Ratione optio nihil eum.</p>
				</div>
			</div>
			<img src="./img/btn-green.png" alt="" class="textalign">
		</div>
		<div class="cleafix mauxam">
			<h3 class="mauxanh margintop">Lorem ipsum dolor sit, amet
			...
			<div class="container over mauxam">
				...
				<div class="float-left column6">
					...
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
						Veritatis, rem id! Quia cumque quisquam maiores blanditiis.</p>
				</div>
				<div class="float-left column6">
					<img src="./img/benefit-5.jpg" alt="">
					<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit.
						Eos inventore iusto obcaecati nihil quidem illum ex qui similique
						commodi ad.</p>
				</div>
				<div class="float-left column6">
		...
		<div class="nenvang cleafix">
			<div class="container mauvang cleafix">
				...
				<div class="float-left column mt-2">
					...
					<h3 class="mautrang">Lorem ipsum dolor sit amet consectetur
						adipisicing elit.</h3>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
						Corporis inventore aliquid tempore.</p>
				</div>
				<div class="float-left column">
		...
		<footer>
			<div class="footer-top">
				...
				<h4 class="mautrang">Lorem ipsum dolor sit amet consectetur
					adipisicing elit. Dolore, labore!</h4>
				<p class="mautrang">Lorem ipsum dolor sit amet consectetur,
					adipisicing elit. Temporibus consequuntur sint deserunt, officia
					neque facere unde eaque dolorem ipsum nesciunt.</p>

			</div>
			<div class="footer-bot">
				Khai giảng tháng 7/2014 và tháng 1/2015 <img
					src="./img/go-to-top.png" alt="" class="logo-top" id="goto-topJS">
			</div>
		</footer>
	</div>
