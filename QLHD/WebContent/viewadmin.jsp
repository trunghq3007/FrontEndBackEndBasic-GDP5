      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/QLHD/viewadmin.jsp"><i class="fa fa-circle-o"></i>Quản lý admin</a></li>
            <li><a href="/QLHD/viewadmin2.jsp"><i class="fa fa-circle-o"></i>Quản lý use</a></li>
          </ul>
        </li>
      </ul>
    </section>
